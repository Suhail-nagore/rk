...
(function () {
  ...
  window.alanzo_storage_get = function (var_name) {
    return alanzo_isset(ALANZO_STORAGE[var_name])
      ? ALANZO_STORAGE[var_name]
      : "";
  };
  ...
  window.alanzo_storage_get_array = function (var_name, key) {
    return alanzo_isset(ALANZO_STORAGE[var_name][key])
      ? ALANZO_STORAGE[var_name][key]
      : "";
  };
  ...
  window.alanzo_empty = function (obj) {
    return (
      ...
      (typeof obj == "string" && alanzo_alltrim(obj) == "") ||
      obj === 0
    );
  };
      ...
      case "object":
        if (mixed_val == null) return "N;";
          ...
          for (var i = 0; i < mixed_val.length; i++) {
            ...
            if (ser) map.push(alanzo_serialize(idxobj.idx) + ser);
          }
          ...
          for (var prop in mixed_val) {
            ...
            if (ser) props.push(alanzo_serialize(prop) + ser);
          }
          if (obj_to_array)
  ...
  window.alanzo_get_date_difference = function (dt1) {
    ...
    } else var a2 = alanzo_parse_date(dt2);
      ...
      .on("click", "tbody .iColorPicker_moreColors", function (e) {
        ...
        if (thead.hasClass("more_colors")) {
          ...
          thead
            ...
            .empty()
            .html(
              out + '<td class="bg_color_white" colspan="8">&nbsp;</td></tr>'
            );
  ...
  window.alanzo_color_picker_show = function (id, fld, func) {
    ...
    var def =
      fld.val().substr(0, 1) == "#"
        ? fld.val()
        : alanzo_rgb2hex(fld.css("backgroundColor"));
    jQuery(
      ...
      for (var prop in obj) {
        ...
        if (
          ...
          dispStr +=
            ...
            prop +
            "=" +
            alanzo_debug_object(obj[prop], recursive, showMethods, level + 1);
        else {
          try {
            curStr = "" + obj[prop];
          } catch (e) {
  ...
  window.dco === undefined &&
    (window.dco = function (s, r) {
      console.log(alanzo_debug_object(s, r));
    });
  window.dal === undefined &&
    (window.dal = function (s) {
      if (ALANZO_STORAGE["user_logged_in"]) alert(s);
    });
  window.dao === undefined &&
    (window.dao = function (s, r) {
      if (ALANZO_STORAGE["user_logged_in"]) alert(alanzo_debug_object(s, r));
    });
  window.ddl === undefined &&
    (window.ddl = function (s, c) {
      alanzo_debug_log(s, c);
    });
  window.ddo === undefined &&
    (window.ddo = function (s, r, c) {
      alanzo_debug_log(alanzo_debug_object(s, r), c);
    });
})();
jQuery(document).ready(function () {
  ...
  function alanzo_init_actions() {
    ...
    if (
      ...
      !alanzo_check_images_complete(jQuery(".menu_side_wrap .sc_layouts_logo"))
    ) {
      setTimeout(function () {
  ...
  function alanzo_ready_actions() {
          ...
          src: [
            {
              ...
              type:
                "video/" +
                alanzo_get_file_ext(ALANZO_STORAGE["background_video"]),
            },
          ],
          onLoad: function () {},
        });
    ...
    if (
      jQuery(".alanzo_tabs:not(.inited)").length > 0 &&
      jQuery.ui &&
      jQuery.ui.tabs
    ) {
    ...
    jQuery(".alanzo_tabs_ajax").on("tabsbeforeactivate", function (event, ui) {
      if (ui.newPanel.data("need-content"))
        alanzo_tabs_ajax_content_loader(ui.newPanel, 1, ui.oldPanel);
    });
    ...
    jQuery(
      ".menu_mobile .menu-item-has-children > a,.sc_layouts_menu_dir_vertical .menu-item-has-children > a"
    ...
    jQuery(".menu_mobile,.sc_layouts_menu_dir_vertical").on(
      ...
      function (e) {
          ...
          if (
            ...
            if ($a.siblings("ul:visible").length > 0)
              ...
              $a.siblings("ul")
                .slideDown(function () {
                  if (
                    !jQuery(this).hasClass("layouts_inited") &&
                    jQuery(this).parents(".menu_mobile").length > 0
                  ) {
        ...
        if (
          !jQuery(this).hasClass("open_child_menu") &&
          jQuery(this).parents(".menu_mobile").length > 0 &&
          alanzo_is_local_link($a.attr("href"))
        )
    ...
    if (
      !ALANZO_STORAGE["trx_addons_exist"] ||
    ...
    jQuery(".nav-links-more a").on("click", function (e) {
      ...
      function alanzo_loadmore_add_items(container, items) {
        ...
        else ALANZO_STORAGE["load_more_link_busy"] = false;
        jQuery(window).trigger("scroll");
  ...
  function alanzo_stretch_sidemenu() {
    ...
    if (
      ALANZO_STORAGE["menu_side_stretch"] &&
      toc_items.length >= 5 &&
      th >= 30
    ) {
      toc_items
  ...
  jQuery(document).on("action.toc_menu_item_active", function () {
    ...
    var th = toc_items.eq(0).height(),
      ...
      menu_side_height =
        ...
        jQuery(".menu_side_wrap .sc_layouts_logo").outerHeight() -
        jQuery(
          ".menu_side_wrap .sc_layouts_logo + .toc_menu_item"
        ).outerHeight();
    if (toc_items_height > menu_side_height) {
      var toc_item_active = jQuery(".menu_side_wrap .toc_menu_item_active").eq(
        0
      );
  ...
  function alanzo_resize_video(cont) {
    ...
    cont.find("video").each(function () {
      if (
        jQuery(this).hasClass("trx_addons_resize") ||
        jQuery(this)
          .addClass("alanzo_resize")
    ...
    if (sb.length > 0) {
      if (content.css("float") == "none") {
        ...
        if (
          ...
          if (scroll_dir == 0) scroll_dir = ALANZO_STORAGE["scroll_dir_last"];
          ...
          if (sb_init.position != "undefined") {
            ...
            if (
              ...
              pos =
                ...
                sb.hasClass("right")
                  ...
                  : sb_init.position == "fixed" &&
                    jQuery("body").hasClass("menu_style_left") &&
                    sb.hasClass("left")
            ...
            if (sb.hasClass("right"))
              sb_init.right =
                sb_init.position == "fixed" ||
                jQuery("body").hasClass("body_style_fullwide")
                  ? pos
                  : 0;
            else
              sb_init.left =
  ...
  function alanzo_init_media_elements(cont) {
    if (
      ALANZO_STORAGE["use_mediaelements"] &&
      ...
      if (window.mejs) {
        ...
        cont.find("audio:not(.inited),video:not(.inited)").each(function () {
          ...
          if (
            jQuery(this).addClass("inited").parents(".mejs-mediaelement")
              .length == 0 &&
  ...
  function alanzo_tabs_ajax_content_loader(panel, page, oldPanel) {
    if (panel.html().replace(/\s/g, "") == "") {
      ...
      panel.html(
        '<div class="alanzo_tab_holder" style="min-height:' +
          height +
          'px;"></div>'
      );
    } else panel.find("> *").addClass("alanzo_tab_content_remove");
      ...
      .done(function (response) {
        ...
        if (rez.error !== "") {
          ...
          panel.prepend(rez.data).fadeIn(function () {
            ...
            setTimeout(function () {
              panel
                .find(".alanzo_tab_holder,.alanzo_tab_content_remove")
                .remove();
              jQuery(window).trigger("scroll");
            }, 600);
          });
  ...
  function alanzo_comments_validate(form) {
    ...
    var comments_args = {
      error_message_text: ALANZO_STORAGE["strings"]["error_global"],
      error_message_show: true,
      error_message_time: 4000,
      error_message_class: "alanzo_messagebox alanzo_messagebox_style_error",
      ...
      rules: [
        {
          ...
          min_length: {
            value: 1,
            message: ALANZO_STORAGE["strings"]["text_empty"],
          },
          max_length: {
            value: ALANZO_STORAGE["comment_maxlength"],
            message: ALANZO_STORAGE["strings"]["text_long"],
          },
        },
      ],
    };
    if (form.find('.comments_author input[aria-required="true"]').length > 0) {
      comments_args.rules.push({
        ...
        min_length: {
          value: 1,
          message: ALANZO_STORAGE["strings"]["name_empty"],
        },
        max_length: {
          value: 60,
          message: ALANZO_STORAGE["strings"]["name_long"],
        },
      });
    }
    if (form.find('.comments_email input[aria-required="true"]').length > 0) {
      comments_args.rules.push({
        ...
        min_length: {
          value: 1,
          message: ALANZO_STORAGE["strings"]["email_empty"],
        },
        max_length: {
          value: 60,
          message: ALANZO_STORAGE["strings"]["email_long"],
        },
        mask: {
          value: ALANZO_STORAGE["email_mask"],
          message: ALANZO_STORAGE["strings"]["email_not_valid"],
        },
      });
    }
...
jQuery(document).on("action.init_hidden_elements", function (e, cont) {
  "use strict";
  if (
    ALANZO_STORAGE["button_hover"] &&
    ALANZO_STORAGE["button_hover"] != "default"
  ) {
    jQuery(
      'button:not(.search_submit):not([class*="sc_button_hover_"]), .theme_button:not([class*="sc_button_hover_"]), .sc_button:not([class*="sc_button_simple"]):not([class*="sc_button_hover_"]), .sc_form_field button:not([class*="sc_button_hover_"]), .post_item .more-link:not([class*="sc_button_hover_"]), .trx_addons_hover_content .trx_addons_hover_links a:not([class*="sc_button_hover_"]), .alanzo_tabs .alanzo_tabs_titles li a:not([class*="sc_button_hover_"]), .hover_shop_buttons .icons a:not([class*="sc_button_hover_style_"]), .mptt-navigation-tabs li a:not([class*="sc_button_hover_style_"]), .edd_download_purchase_form .button:not([class*="sc_button_hover_style_"]), .edd-submit.button:not([class*="sc_button_hover_style_"]), .widget_edd_cart_widget .edd_checkout a:not([class*="sc_button_hover_style_"]), #buddypress a.button:not([class*="sc_button_hover_"]) '
    ).addClass(
      "sc_button_hover_just_init sc_button_hover_" +
        ALANZO_STORAGE["button_hover"]
    );
    if (ALANZO_STORAGE["button_hover"] != "arrow") {
      jQuery(
    ...
    jQuery(
      '.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]), .alanzo_tabs .alanzo_tabs_titles li a:not([class*="sc_button_hover_style_"]), .widget_tag_cloud a:not([class*="sc_button_hover_style_"]), .widget_product_tag_cloud a:not([class*="sc_button_hover_style_"]) '
    ...
    jQuery(
      ".mejs-controls button, .mfp-close, .sc_button_bg_image, .hover_shop_buttons a, button.pswp__button, .sc_layouts_row_type_narrow .sc_button "
    ).removeClass("sc_button_hover_" + ALANZO_STORAGE["button_hover"]);
  }
});
(function () {
  "use strict";
  jQuery(document).on(
    ...
    alanzo_trx_addons_add_googlemap_styles
  );
  ...
  function alanzo_trx_addons_init(e, container) {
    ...
    container
      ...
      .addClass("inited")
      .attr("data-color", ALANZO_STORAGE["alter_link_color"]);
  }
})();
