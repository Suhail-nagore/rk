  ...
  s.prototype = {
    open(e, t) {
      ...
      "group" == i
        ...
        : s.setAttribute(
            "href",
            n + "?phone=" + o + "&text=" + encodeURIComponent(a)
          );
    ...
    chat(e, t) {
      ...
      w && (w.setAttribute("src", o), w.setAttribute("alt", i)),
        q && (q.innerHTML = u),
        m && (m.innerHTML = i),
    ...
    init(s) {
      ...
      if (
        ...
        i.classList.contains("auto-load") &&
          !(function (e) {
        ...
        setTimeout(() => {
          ...
          (function (e, t, n) {
            ...
            s.setTime(s.getTime() + 864e5 * n),
              (document.cookie =
                e + "=" + t + ";path=/;expires=" + s.toGMTString());
      ...
      i.addEventListener("qlwapp.init", function (e) {
        ...
        i.addEventListener("qlwapp.time", function (s) {
          const a = s.target,
            ...
            l = new Date(new Date().getTime() + 60 * i * 1e3)
              .getUTCDay()
              .toString(),
          ...
          if (o && o.length && !o.includes(l)) {
            ...
            const t = (function (t, n) {
                for (let s = t; s <= 6; s++) if (e(n, s)) return s;
                for (let s = 0; s <= t; s++) if (e(n, s)) return s;
              })(l, o),
          ...
          o &&
            o.length &&
            o.includes(l) &&
            (p && (p.style.display = "none"), r && (r.style.display = "block"));
        ...
        i.addEventListener("qlwapp.pro", function () {
          const e = i.querySelector(".qlwapp-toggle"),
            ...
            n = new CustomEvent("qlwapp.time", { bubbles: !0 });
          e.dispatchEvent(n),
        ...
        i.addEventListener("qlwapp.init", function () {
          s.mobiledevice
            ? (i.classList.add("mobile"), i.classList.remove("desktop"))
            : (i.classList.add("desktop"), i.classList.remove("mobile")),
            i.classList.add("qlwapp-js-ready");
        }),
        i.addEventListener("qlwapp.init", function () {
        ...
        i.addEventListener("qlwapp.toggle", function (e) {
          ...
          t.classList.add("qlwapp-transition"),
            ...
            setTimeout(function () {
              ...
              const e = new CustomEvent("qlwapp.height", { bubbles: !0 });
              t.dispatchEvent(e);
            }, 10),
            setTimeout(function () {
        ...
        i
          .querySelector("[data-action=response]")
  ...
  (() => {
    window.qlwapp = (e, t) => {
      if (void 0 === t || "object" == typeof t)
        ...
        return (
          "destroy" === t && (e.plugin_qlwapp = null), void 0 !== n ? n : e
        );
      }
    };
    const e = () => {
