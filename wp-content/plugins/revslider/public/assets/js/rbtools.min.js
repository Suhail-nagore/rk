     ...
     */ (s = function (t) {
      ...
      function m(m, v) {
            ...
            if (
              ...
              return (
                ...
                !l || I === v.fingers || v.fingers === h || st()
                  ? ((Y = wt()),
                    2 == I &&
                      (_t(1, l[1]), (P = B = xt(z[0].start, z[1].start))),
        ...
        function G(s) {
          ...
          if (R !== D && R !== p && !dt()) {
            ...
            if (
              ...
              2 == I &&
                (0 == P
                  ? (_t(1, x[1]), (P = B = xt(z[0].start, z[1].start)))
                  : (mt(x[1]),
        ...
        function Q(t) {
          ...
          if (r) {
            if (r.length && !dt())
              return (e = n), (X = wt()), (V = e.touches.length + 1), !0;
  ...
  function (t, e, n) {
    ...
    var u,
      ...
      te = function (t, e) {
        return !z(t) || e || (!a && xe())
          ? H(t)
            ...
            ? [t]
            : []
          : Zt.call(o.querySelectorAll(t), 0);
      },
      ee = function (t) {
      ...
      re = function (t) {
        ...
        return function (n) {
          return (
            ~~(Math.round(parseFloat(n) / t) * t * e) / e + (j(n) ? 0 : Kt(n))
          );
        };
      },
      ie = function (t, e) {
      ...
      de = function (t, e, n) {
        var r,
          ...
          f,
          D,
          p = t ? (j(t) ? [t >> 16, (t >> 8) & 255, 255 & t] : 0) : pe.black;
        if (!p) {
      ...
      Me(
        ...
        (M = function (t) {
          return t < A
            ...
            ? b * Math.pow(t - 1.5 / T, 2) + 0.75
            : t < 0.9090909090909092
            ? b * (t -= 2.25 / T) * t + 0.9375
            : b * Math.pow(t - 2.625 / T, 2) + 0.984375;
        })
      ),
      Me("Expo", function (t) {
    ...
    var Le = (function (t) {
      ...
      return (
        ...
        (n.render = function (t, e, n) {
          ...
          if (v !== this._tTime || n || y) {
            ...
            if (
              ...
              return (this._start = D), Yt(this), this.render(t, e, n);
            this._onUpdate && !e && he(this, "onUpdate", !0),
              ((v === _ && _ >= this.totalDuration()) ||
                ...
                ((D !== this._start && Math.abs(f) === Math.abs(this._ts)) ||
                  ...
                  e ||
                    (t < 0 && !g) ||
                    (he(this, v === _ ? "onComplete" : "onReverseComplete", !0),
        ...
        (n.addPause = function (t, e, n) {
          ...
          return (
            (r.data = "isPause"), (this._hasPause = 1), Xt(this, r, Ht(this, t))
          );
        }),
        ...
        (n.clear = function (t) {
          ...
          return (
            (this._time = this._tTime = 0), t && (this.labels = {}), Lt(this)
          );
        }),
          ...
          if (a._dirty) {
            for (i = a.parent; o; )
              (e = o._prev),
                ...
                (r = o._start) > l && a._sort && o._ts && !a._lock
                  ? ((a._lock = 1), (Xt(a, o, r - o._delay, 1)._lock = 0))
                  : (l = r),
                r < 0 &&
                  o._ts &&
                  ((s -= r),
    ...
    var Ne,
      Re = function (t, e, n, r, i, u, s) {
        var a,
          ...
          p,
          c,
          d = new un(this._pt, t, e, 0, 1, $e, null, i),
          g = 0,
          _ = 0;
        for (
          d.b = n,
      ...
      Ie = function (t, e, n, r, i, u, s, a, o) {
        ...
        if (
          ...
          return isNaN(f + r)
            ? (!h && !(e in t) && it(e, r),
              Re.call(this, t, e, f, r, D, a || P.stringFilter, o))
            : ((l = new un(
                this._pt,
                t,
                e,
      ...
      ze = function (t, e, n, r, i, u) {
        ...
        if (
          ...
          ((n._pt = a = new un(n._pt, i, t, 0, 1, s.render, s, 0, s.priority)),
          n !== f)
        )
          for (
      ...
      Ye = function t(e, n) {
        ...
        if (
          ...
          for (
            ...
            if (
              ((h = (o = P[i])._gsap || gt(P)[i]._gsap),
              (e._ptLookup[i] = p = {}),
              ht[h.id] && Ft(),
              (c = O === P ? i : O.indexOf(o)),
              f &&
                !1 !== (D = new f()).init(o, d || r, e, c, O) &&
                ((e._pt = a =
                  new un(e._pt, o, D.name, 0, 1, D.render, D, 0, D.priority)),
              ...
              for (s in r)
                ft[s] && (D = ze(s, r, e, c, o, O))
                  ? D.priority && (l = 1)
                  : (p[s] = a =
                      Ie.call(e, o, s, "get", r[s], c, O, 0, g.stringFilter));
            e._op && e._op[i] && e.kill(o, e._op[i]),
              k &&
                e._pt &&
                ((Ne = e), u.killTweensOf(o, p, "started"), (Ne = 0)),
              e._pt && y && (ht[h.id] = 1);
          }
      ...
      Ue = (function (t) {
        function e(e, n, i, s) {
          ...
          var o,
            ...
            c,
            d,
            g = (a = t.call(this, s ? n : St(n), i) || this).vars,
            _ = g.duration,
            m = g.delay,
            v = g.immediateRender,
            y = g.stagger,
          ...
          if (
            ...
            if (
              ((n = a.vars),
              (o = a.timeline =
                new Le({ data: "nested", defaults: F || {} })).kill(),
              (o.parent = r(a)),
              x)
            )
              Tt(o.vars.defaults, { ease: "none" }),
          ...
          return (
            !0 === C && ((Ne = r(a)), u.killTweensOf(E), (Ne = 0)),
            w && jt(w, r(a)),
            (v ||
              (!_ &&
                !x &&
              ...
              !(function (t, e, n, r) {
                ...
                if (
                  (a &&
                    t._repeat &&
                    ((o = Qt(0, t._tDur, e)),
                    It(o, a) !== It(t._tTime, a) &&
                      ((u = 1 - s),
                      t.vars.repeatRefresh && t._initted && t.invalidate())),
                  (t._initted || !Vt(t, e, r, n)) &&
                    (s !== u || r || 1e-8 === t._zTime || (!e && t._zTime)))
                ) {
                  for (
                    t._zTime = e || (n ? 1e-8 : 0),
                      t.ratio = s,
     ...
     */ var hn,
      ...
      $n = function t(e, n, r, i) {
        var u,
          ...
          d = "px" === i,
          g = "%" === i;
        return i === h || !l || Zn[i] || Zn[h]
          ? l
          : ("px" !== h && !d && (l = t(e, n, r, "px")),
            (o = e.getCTM && Gn(e)),
            g && (mn[n] || ~n.indexOf("adius"))
              ? yt((l / (o ? e.getBBox()[D ? "width" : "height"] : e[c])) * 100)
              : ((f[D ? "width" : "height"] = 100 + (d ? h : i)),
                ...
                (a = s._gsap) && g && a.width && D && a.time === Ce.time
                  ? yt((l / a.width) * 100)
                  : ((g || "%" === h) && (f.position = jn(e, "position")),
                    s === e && (f.position = "static"),
                    s.appendChild(cn),
                    (u = cn[c]),
                    s.removeChild(cn),
                    (f.position = "absolute"),
                    D && g && (((a = _t(s)).time = Ce.time), (a.width = s[c])),
      ...
      tr = function (t, e, n, r) {
        ...
        var s,
          ...
          g,
          _,
          m = new un(this._pt, t.style, e, 0, 1, $e),
          v = 0,
          y = 0;
        if (
          ((m.b = n),
        ...
        return s.svg && t.getAttribute("transform")
          ...
          : (o !== ir ||
              ...
              ((n = t.parentNode) && t.offsetParent) ||
                ((u = 1), (r = t.nextSibling), Dn.appendChild(t)),
              (o = ar(t)),
      ...
      lr = function (t, e, n, r, i, u) {
        ...
        n
          ? h !== ir &&
            ...
            (F = o))
          : ((x =
              (s = Hn(t)).x + (~C[0].indexOf("%") ? (x / 100) * s.width : x)),
            (F =
      ...
      _r = function (t, e, n) {
        ...
        mn))
          (u = f[i]) !== (s = r[i]) &&
            ...
            ((a = Kt(u) !== (l = Kt(s)) ? $n(n, i, u, l) : parseFloat(u)),
            (o = parseFloat(s)),
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  if (
                    (g ||
                      ((_ = t._gsap).renderTransform || hr(t),
                      ...
                      (C = void 0),
                        ...
                        _.svg
                          ...
                          : ((p = parseFloat(s.split(" ")[2]) || 0) !==
                              _.zOrigin && Kn(this, _, "zOrigin", _.zOrigin, p),
                ...
                if (
                  d ||
                  ((a || 0 === a) && (o || 0 === o) && !wn.test(s) && f in E)
                )
                  a || (a = 0),
                    (D = (u + "").substr((o + "").length)) !==
                      (p =
                        (s + "").substr((a + "").length) ||
                        (f in P.units ? P.units[f] : D)) &&
                      (o = $n(t, f, u, p)),
                    (this._pt = new un(
                      this._pt,
                      d ? _ : E,
                      ...
                      o,
                      c ? c * a : a - o,
                      "px" !== p || !1 === e.autoRound || d ? bn : Mn
                    )),
                    (this._pt.u = p || 0),
                    D !== p && ((this._pt.b = u), (this._pt.r = An));
    ...
    (ln.utils.checkPrefix = Vn),
      (vr = vt(
        "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," +
          (mr = "rotation,rotationX,rotationY,skewX,skewY") +
    ...
    var Cr,
      ...
      Tr = function (t) {
        (Cr = br()),
          (Fr = Cr && Cr.parseEase("_CE"))
            ? ((xr = 1),
              (Cr.parseEase("bounce").config = function (t) {
                return "object" == typeof t
                  ? Mr("", t)
                  : Mr("bounce(" + t + ")", { strength: +t });
              }))
            : t &&
              console.warn(
    ...
    function Zr(t) {
      var e,
        n = (t = (Xr(t) && kr.test(t) && document.querySelector(t)) || t)
          .getAttribute
          ? t
          : 0;
      return n && (t = t.getAttribute("d"))
        ? (n._gsPath || (n._gsPath = {}),
          (e = n._gsPath[t]) && !e._dirty ? e : (n._gsPath[t] = hi(t)))
        : t
        ? Xr(t)
          ? hi(t)
          : Vr(t[0])
          ...
          "rect" === w
            ...
            : ("polyline" !== w && "polygon" !== w) ||
              ((n =
                "M" +
                (r = (h =
                  (t.getAttribute("points") + "").match(Sr) || []).shift()) +
                "," +
                (i = h.shift()) +
                " L" +
                h.join(",")),
        ...
        if (
          (Gr(p, y, x, d.t) &&
            ...
            w
              ...
              : y <= v + 1 && !E && (v++, F && (C -= x))),
          g.t ? Gr(p, v, C, g.t) && (E && s && y++, r && v++) : (v--, r && y--),
          (l = []),
          (f = 1 + (h = p.length) * i),
          (D = y),
          r)
          ...
          for (f += (h - (v = (v || h) - 1) + y) % h, o = 0; o < f; o++)
            Kr(l, p[D]), (D = (D || h) - 1);
        else for (f += (h - y + v) % h, o = 0; o < f; o++) Kr(l, p[D++ % h]);
        p = l;
      } else if (((a = 1 === g.t ? 6 : ui(_, C, g.t)), e !== n))
        for (
          s = ui(m, x, w ? d.t / g.t : d.t),
            F && (a += s),
            _.splice(C + a + 2),
            (s || x) && m.splice(0, x + s),
            o = p.length;
    ...
    function ii(t, e) {
      ...
      for (i = n = r = 0; i < t.length; i++)
        (t[i].resolution = ~~e || 12), (r += t[i].length), (n += ri(t[i]));
    ...
    function li(t, e, n, r, i, u, s, a, o) {
      if (t !== a || e !== o) {
        ...
        var w = (u === s ? -1 : 1) * Yr(F),
          ...
          L =
            (M * S - P * B < 0 ? -1 : 1) *
            Math.acos((M * B + P * S) / Yr(O * (B * B + S * S)));
        isNaN(L) && (L = D),
          !s && L > 0 ? (L -= p) : s && L < 0 && (L += p),
          (k %= p),
          (L %= p);
        var N,
          R = Math.ceil(zr(L) / (p / 4)),
          I = [],
          z = L / R,
     ...
     */ var ci,
      ...
      _i = function () {
        (ci = gi())
          ? (ci.registerEase("_CE", xi.create), (di = 1))
      ...
      xi = (function () {
        ...
        return (
          (e.setData = function (t, e) {
            ...
            if (
              ((this.data = t),
              (yi.test(t) || (~t.indexOf("M") && t.indexOf("C") < 0)) &&
                (f = hi(t)[0]),
              4 === (n = f.length))
            )
    ...
    var Fi,
      ...
      Pi = function (t, e) {
        return (
          "function" != typeof t && (t = Fi.parseEase(t) || Ei("", t)),
          t.custom || !e
            ? t
            : function (e) {
                return 1 - t(e);
    ...
    var Oi,
      ...
      qi = function (t, e, n, r, i, u) {
        return Wi(
          Math.pow((Vi(n) - Vi(t)) * i, 2) + Math.pow((Vi(r) - Vi(e)) * u, 2)
        );
      },
      Hi = function (t) {
      ...
      Qi = function (t) {
        ...
        if (
          ...
          for (
            r = t.getAttribute("points").match(Yi) || [],
          ...
          return (
            ...
            (s = (function (t, e, n) {
              ...
              return (
                ...
                (r = ~r.indexOf("%") ? (Vi(r) / 100) * e : Vi(r)) >
                (i = ~i.indexOf("%") ? (Vi(i) / 100) * e : Vi(i))
                  ? [i, r]
                  : [r, i]
              );
            })(e, l, (u = Ki(t, l))[0])),
            ...
            Ni &&
              (o = Li.getComputedStyle(t)).strokeLinecap !== o.strokeLinejoin &&
              ((s = Vi(o.strokeMiterlimit)),
    ...
    var Ji,
      ...
      pu = function t(e, n) {
        if (e.parentNode && (Ji || lu(e))) {
          var r = Du(e),
            ...
            l = Ji.createElementNS
              ? Ji.createElementNS(i.replace(/^https/, "http"), u)
              : Ji.createElement(u);
          return (
            n &&
              (r
      ...
      cu = function (t, e) {
        ...
        if (t === tu) return t;
        if (
          (l.length || l.push(pu(t, 1), pu(t, 2), pu(t, 3)),
          (n = a ? iu : ru),
          a)
        )
          ...
          if (((u = s = 0), su))
            for (
              ...
              (tu.getComputedStyle(i)[au] + "").length > 4 &&
    ...
    function _u(t, e, n) {
      ...
      var r = Du(t) ? hu : fu,
        ...
        l = (function t(e) {
          return (
            "fixed" === tu.getComputedStyle(e).position ||
     ...
     */ var mu,
      ...
      Au = function (t, e, n, r, i, u, s) {
        "cubic" === s.type
          ? (e = [e])
          : (e.unshift(bu(n, r, s.unitX), i ? bu(n, i, s.unitY) : 0),
            s.relative && Tu(e),
      ...
      Su = function (t, e, n, r) {
        ...
        return (
          ...
          "auto" === r &&
            ...
            ((i = e.getAttribute("d").match(Pu) || []),
            (l += (i = s.apply({ x: +i[0], y: +i[1] })).x),
            (h += i.y)),
          (i || (e.getBBox && t.getBBox)) &&
          ...
          ? (s &&
              ("self" === s || (r = Cu(s)[0] || e) === e
                ...
                : (h && !1 !== h[2]
                  ...
                  (u = (i = Su(e, r, h, "auto")).apply({ x: f, y: D })),
                  oi(
                    t,
                    i.a,
                    i.b,
            ...
            a
              ? oi(t, a.a, a.b, a.c, a.d, a.e, a.f)
              : (o || l) && oi(t, 1, 0, 0, 1, o || 0, l || 0),
            t)
          : Zr("M0,0L0,0");
      },
      ...
      Lu = {
        ...
        init: function (t, e) {
          ...
          if (
            ...
            h))
              r !== i &&
                r !== u &&
                o.push(Au(this, Eu([], l, r, 0), t, r, 0, D, e));
          } else
        ...
        render: function (t, e) {
          ...
          e.rotate &&
            e.rSet(
              e.target,
              e.rProp,
              n[0].angle * (e.radians ? wu : 1) + e.rOffset + e.ru,
              e,
              t
            );
        },
        ...
        arrayToRawPath: function (t, e) {
          ...
          return (
            e.relative && Tu(n), ["cubic" === e.type ? n : Di(n, e.curviness)]
          );
        },
      };
    (mu ||
    ...
    var Nu,
      ...
      qu = function (t, e) {
        var n = "x" === e ? "Width" : "Height",
          r = "scroll" + n,
          i = "client" + n;
        return t === Iu || t === zu || t === Yu
          ? Math.max(zu[r], Yu[r]) - (Iu["inner" + n] || zu[i] || Yu[i])
          : t[r] - t["offset" + n];
      },
      Hu = function (t, e) {
        ...
        var n = ju(t)[0].getBoundingClientRect(),
          ...
          i = r
            ? {
                top:
                  zu.clientTop -
                  (Iu.pageYOffset || zu.scrollTop || Yu.scrollTop || 0),
                left:
                  zu.clientLeft -
                  (Iu.pageXOffset || zu.scrollLeft || Yu.scrollLeft || 0),
              }
      ...
      Zu = {
        ...
        render: function (t, e) {
          ...
          (n = p || !e.skipX ? e.getX() : f),
            ...
            e.y < 0 && (e.y = 0),
            h &&
              (!e.skipX && (u > s || u < -s) && n < qu(o, "x") && (e.skipX = 1),
            ...
            p
              ? Iu.scrollTo(e.skipX ? n : e.x, e.skipY ? r : e.y)
    ...
    var Ju,
      ...
      os = function (t, e) {
        ...
        return ss(t)
          ...
          ? as.call(Ju.querySelectorAll(t), 0)
      ...
      _s = function (t, e, n, r, i, u, s) {
            ...
            ((D = (h = f[a]).parentNode === t) || R || (N && !L)) &&
              ...
              k &&
                (((h._isSplit && D) ||
                  ...
                  (p.push(h), (h._x -= y), cs(h, t, B) && (h._wordEnd = !0)),
                "BR" === h.nodeName &&
                ...
                !L && N
                  ? h._isSplit
                    ...
                    ? ((h._parent = h.parentNode),
                      ...
                      l--)
                    : D ||
                      ((m = !h.nextSibling && cs(h.parentNode, t, B)),
        ...
        if (k) {
          ...
          for (c = " " === B && (!R || (!L && !N)), a = 0; a < k.length; a++) {
            for (
              p = k[a],
                (g = Ju.createElement(S)).style.cssText =
            ...
            0 === l
              ? (g.innerHTML = "&nbsp;")
              : L || N || (ds(g), Ds(g, String.fromCharCode(160), " ")),
        ...
        for (
          ...
          if (((l = i.charAt(s)), v && (f = v(i.substr(s), e.specialChars))))
            ...
            "{" === l && "{{LT}}" === i.substr(s, 6)
              ...
              ? ((a = ((i.substr(s, 12).split($u) || [])[1] || "").length || 2),
                (u +=
                  p && " " !== l
                    ? r() + i.substr(s, a) + "</" + D + ">"
                    : i.substr(s, a)),
    ...
    Cs.gsap.config({ nullTargetWarn: !1 }),
    /*!FallBack for old and new Eases*/
    (Cs.eases = Cs.gsap.parseEase()),
    Cs.eases))
      Cs.eases.hasOwnProperty(xs) &&
        void 0 === Cs[xs] &&
        (Cs[xs] = Cs.eases[xs]);
      /*! FallBack for Essential Grid */
    void 0 !== ns &&
      void 0 !== ns.TweenLite &&
      void 0 === ns.TweenLite.lagSmoothing &&
      (ns.TweenLite.lagSmoothing = function () {});
  },
]);
