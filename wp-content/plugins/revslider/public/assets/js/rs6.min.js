    ...
    e.fn.extend({
      revolution: function (o) {
        return this.each(function () {
          ...
          this.id !== t
            ? ((i[n] = { anyid: [] }), (this.id = i.revCheckIDS(n, this, !0)))
            : (this.id = "rs_module_" + Math.round(1e7 * Math.random()));
          var n = this.id,
            d = e.extend(!0, {}, o);
          (i[n] = F(o)),
            (i[n].ignoreHeightChange =
              a &&
              "fullscreen" === i[n].sliderLayout &&
              i[n].ignoreHeightChange),
            (i[n].option_export = d),
            (i[n].anyid = []),
            (i[n].c = e(this)),
            ...
            (i[n].noDetach = i[n].BUG_ie_clipPath =
            ...
            i[n].stopAfterLoops != t && i[n].stopAfterLoops > -1
              ? (i[n].looptogo = i[n].stopAfterLoops)
              : (i[n].looptogo = "disabled"),
            (i[n].BUG_safari_clipPath =
              "Safari" === i.get_browser() && i.get_browser_version() > "12"),
            (i[n].minHeight =
              "fullwidth" === i[n].sliderLayout
                ? 0
                : i[n].minHeight != t && "" !== i[n].minHeight
                ? parseInt(i[n].minHeight, 0)
                : 0),
            ...
            "hero" == i[n].sliderType &&
              i[n].c.find("rs-slide").each(function (t) {
                t > 0 && e(this).remove();
              }),
            (i[n].navigation.use =
              "hero" !== i[n].sliderType &&
              ("carousel" == i[n].sliderType ||
                i[n].navigation.keyboardNavigation ||
                "on" == i[n].navigation.mouseScrollNavigation ||
                "carousel" == i[n].navigation.mouseScrollNavigation ||
                i[n].navigation.touch.touchenabled ||
                i[n].navigation.arrows.enable ||
                i[n].navigation.bullets.enable ||
                i[n].navigation.thumbnails.enable ||
                i[n].navigation.tabs.enable)),
            ...
            (tpGS.force3D = "auto"),
            !0 === i[n].modal.useAsModal &&
              -1 === i.RS_prioList.indexOf(n) &&
              ((i.RS_toInit[n] = !1), i.RS_prioList.push(n)),
            i.RS_killedlist !== t &&
              -1 !== i.RS_killedlist.indexOf(n) &&
              ((i.RS_toInit[n] = !1), i.RS_prioList.push(n)),
    ...
    e.extend(!0, i, {
      ...
      enterViewPort: function (a, r) {
        !0 !== i[a].started
          ...
          : (i[a].waitForCountDown && (G(a), (i[a].waitForCountDown = !1)),
              ...
              !0 === i.static &&
                ...
                ("failed" != i.progress || i.reported
                  ? !i.error && e.now() - i.starttoload < 5e3
                    ? (n = !0)
                    : i.reported || (i.reported = T(i.src, i.error))
                  : (i.reported = T(i.src, i.error)));
            }),
            n
      ...
      getComingSlide: function (a, r) {
        ...
        if (
          ...
          i[a].pr_active_slide !== t &&
            "true" == i.gA(i[a].pr_active_slide[0], "not_in_nav") &&
      ...
      updateDimensions: function (e, a) {
        if (
          ...
          var r = i[e].width;
          i[e].height;
          (i[e].navOutterOffsets =
            i[e].navOutterOffsets === t
              ? i.getHorizontalOffset(i[e].c, "all")
              : i[e].navOutterOffsets),
            ...
            i[e].navigation.thumbnails.enable &&
              i[e].navOutterOffsets !== t &&
              0 !== i[e].navOutterOffsets.both &&
              r !== i[e].width &&
              (v(e),
              i.setSize(e, !0, "updateDimensions"),
              "carousel" === i[e].sliderType &&
                i[e].carousel.carouselInitialised &&
            ...
            i.scrollBarWidth > 0 &&
              i.openModalId !== t &&
              e !== i.openModalId &&
              ((i[e].lastconw = i[e].lastconw - i.scrollBarWidth),
              (i[e].conw = i[e].conw - i.scrollBarWidth),
              (i[e].width = i[e].width - i.scrollBarWidth)),
            (i[e].gridOffsetWidth =
              (i[e].width - i[e].gridwidth[i[e].level]) / 2),
            (i[e].gridOffsetHeight =
              (i[e].height - i[e].gridheight[i[e].level]) / 2),
      ...
      contWidthManager: function (e, a) {
        ...
        var o,
          s = i[e].navOutterOffsets.left,
          n =
            i[e].blockSpacing !== t && i[e].blockSpacing.left !== t
              ? parseInt(i[e].blockSpacing.left[i[e].level], 0)
              : 0,
          l =
            n +
            (i[e].blockSpacing !== t && i[e].blockSpacing.right !== t
        ...
        (i[e].conw = i[e].conw === t ? i[e].c.width() : i[e].conw),
          ...
          ("fullscreen" === i[e].sliderLayout &&
            ...
            : (o = {
                left:
                  0 - Math.ceil(i[e].rsFullWidthWrap.offset().left - (s + n)),
                width: d - (i[e].navOutterOffsets.both + l),
              }),
          o === t ||
            (i[e].caches.contWidthManager !== t &&
              i[e].caches.contWidthManager.left === o.left &&
              i[e].caches.contWidthManager.width === o.width) ||
            (tpGS.gsap.set(i[e].cpar, o),
            (i[e].caches.contWidthManager = { left: o.left, width: o.width }),
            (i[e].dimensionChanged = !0)),
          "auto" === i[e].sliderLayout &&
            i[e].modal !== t &&
            i[e].modal.useAsModal &&
            ((i[e].canvasWidth = Math.min(i[e].gridwidth[i[e].level], d)),
          ...
          i[e].slayers &&
            ...
            "fullscreen" != i[e].sliderLayout &&
            tpGS.gsap.set(i[e].slayers, { left: s }),
          i[e].navOutterOffsets.both !== r &&
            ((i[e].dimensionChanged = !0),
      ...
      setSize: function (e, a, r) {
        var o,
          s,
          n = parseInt(i[e].top_outer || 0) + parseInt(i[e].bottom_outer || 0),
          l = 0,
          d = 0,
          c = 0,
        ...
        if (
          ((u.marginTop =
            "carousel" == i[e].sliderType
              ? parseInt(i[e].carousel.padding_top || 0, 0)
              : 0),
          (u.marginBottom =
            "carousel" == i[e].sliderType
              ? parseInt(i[e].carousel.padding_bottom || 0, 0)
              : 0),
          i[e].blockSpacing !== t &&
          ...
          if (i[e].rowzones[p] !== t)
            for (o = 0; o < i[e].rowzones[p].length; o++)
              (i[e].rowzonesHeights[p][o] =
                i[e].rowzones[p][o][0].offsetHeight),
                (l += i[e].rowzonesHeights[p][o]);
          if (g !== p)
            for (o = 0; o < i[e].rowzones[g].length; o++)
              (i[e].rowzonesHeights[g][o] =
                i[e].rowzones[g][o][0].offsetHeight),
        ...
        if (
          ...
          "fullwidth" != i[e].sliderLayout ||
            i[e].autoHeight ||
            ((u.maxHeight = Math.max(
              Math.max(i[e].minHeight, i[e].gridheight[i[e].level]),
              l
            )),
            (u.maxHeight =
              0 !== i[e].maxHeight
                ? Math.min(i[e].maxHeight, u.maxHeight)
                : u.maxHeight)),
          (i[e].width =
            i[e].width === t || 0 === i[e].width
              ? i[e].canvas.width()
              : i[e].width),
          (i[e].height =
            i[e].height === t || 0 === i[e].height
              ? i[e].canvas.height()
              : i[e].height),
          ...
          (i[e].height = Math.max(l, Math.max(m - n, i[e].minHeight))),
            g !== p &&
              ((i[e].currentSlideHeight = Math.max(
                d,
                Math.max(m - n, i[e].minHeight)
              )),
              (i[e].slides[g].style.maxHeight =
                i[e].currentSlideHeight !== i[e].height
                  ? i[e].currentSlideHeight + "px"
                  : "none")),
            (h.height = i[e].height),
            (u.height = "100%");
        } else
          (i[e].height = Math.round(
            i[e].gridheight[i[e].level] *
              (i[e].keepBPHeight ? 1 : i[e].width / i[e].gridwidth[i[e].level])
          )),
            (i[e].height = Math.max(
              l,
              Math.max(
                i[e].autoHeight
                  ? i[e].height
                  : Math.min(i[e].height, i[e].gridheight[i[e].level]),
                i[e].minHeight
              )
            )),
        ...
        if (
          ...
          f !== i[e].caches.setsize__h &&
            ((i[e].caches.setsize__h = f),
            tpGS.gsap.set(i[e].forcer, { height: f }));
        } else
          !1 !== a &&
            s !== i[e].caches.setsize_h &&
            i[e].forcer !== t &&
            ((i[e].caches.setsize_h = s),
            tpGS.gsap.set(i[e].forcer, { height: s }));
        u !== i[e].emptyObject &&
          JSON.stringify(u) !== i[e].caches.setsizeCOBJ &&
          ((i[e].caches.setsizeCOBJ = JSON.stringify(u)),
          tpGS.gsap.set(i[e].c, u)),
          h !== i[e].emptyObject &&
            JSON.stringify(h) !== i[e].caches.setsizeCPAROBJ &&
            ((i[e].caches.setsizeCPAROBJ = JSON.stringify(h)),
          ...
          i[e].modal !== t &&
            ...
            ((i[e].modal.calibration.top = i.getWinH(e) < s ? "0%" : "50%"),
        ...
        var y =
          i[e].inviewport &&
          ((i[e].heightInLayers !== t && i[e].height !== i[e].heightInLayers) ||
            (i[e].widthInLayers !== t && i[e].width !== i[e].widthInLayers));
        (i[e].heightInLayers = t),
          (i[e].widthInLayers = t),
          y &&
            (i[e].autoHeight && (i[e].dimensionChanged = !0),
    ...
    r =
      ...
      function (e) {
        ...
        i[e].editorheight !== t &&
          ...
          i[e].cpar !== t && i[e].cpar[0].offsetHeight < a
            ? tpGS.gsap.set([i[e].cpar, i[e].c], { height: a })
      ...
      n &&
        ...
        e.each(n, function (e, a) {
          i.winWAll < a &&
            ...
            i.winWAll > a && o < a && ((o = parseInt(a)), (s = e));
        }),
        o < r && (i[t].level = s),
        ...
        for (var u in i[r].slides)
          if (i[r].slides.hasOwnProperty(u) && "length" !== u) {
            ...
            if (
              ...
              c > 0 && tpGS.gsap.set(h, { borderRadius: c + "px" }),
        ...
        if (
            ...
            i[r].c
              ...
              .each(function () {
                ...
                if (
                  ...
                  "row" === n.type || "column" === n.type || "group" === n.type
                ...
                R.find("rs-zone").each(function () {
                  i[r].rowzones[b].push(e(this)),
                    this.className.indexOf("rev_row_zone_middle") >= 0 &&
                      i[r].middleZones[b].push(this);
                }),
                ((A.enable && i[r].inviewport) || !A.enable) &&
                  "all" == i[r].lazyType &&
                  (i.loadImages(R[0], r, b),
          ...
          (i[r].srowzones = []),
            ...
            i.document.on(
              ...
              function () {
                if (i[r] !== t) {
                  if (i[r].c == t) return !1;
                  0 != e("body").find(i[r].c) &&
                    (l(r), i.contWidthManager(r, "onResize_RunSlider")),
                    (i[r].fullScreenMode = i.checkfullscreenEnabled(r)),
                    i[r].c.outerWidth(!0) != i[r].width ||
                    i[r].c.is(":hidden") ||
                    ("fullscreen" == i[r].sliderLayout &&
                      i.getWinH(r) != i.lastwindowheight)
                      ? ((i.lastwindowheight = i.getWinH(r)), m(r))
                      : i[r].levelInLayers !== t &&
                        i[r].levelInLayers !== i[r].level &&
                        ((i.lastwindowheight = i.getWinH(r)), m(r));
                }
              }
            ),
            ...
            ("off" != i[r].parallax.type ||
              ...
              !0 === A.enable) &&
              i.scrollTicker(r),
            !0 !== A.enable && ((i[r].inviewport = !0), i.enterViewPort(r)),
            i.RS_toInit !== t && (i.RS_toInit[r] = !0);
        }
      }
    },
        ...
        if (
          ...
          if (
            ...
            for (var o in i[e].panzoomTLs)
              i[e].panzoomTLs.hasOwnProperty(o) &&
                i.startPanZoom(
                  i[e].panzoomBGs[o],
                  e,
                  i[e].panzoomTLs[o].progress(),
                  o,
                  i[e].panzoomTLs[o].isActive() ? "play" : "reset"
                );
        ...
        for (var o in (i[a].syncload--, i[a].loadqueue))
          if (
            ...
            (s === e.src ||
              ...
              w(k(self.location.href, i[a].loadqueue[o].src)) ===
                w(decodeURIComponent(n)) ||
        ...
        if (
          ...
          if ("module" === r.basedon) {
            ...
            (i[a].progressC[0].innerHTML = o),
              ...
              (i[a].progressCBarBGS =
                i[a].progressC[0].getElementsByTagName("RS-PROGRESS-BG")),
              (i[a].progressCBarGAPS =
                i[a].progressC[0].getElementsByTagName("RS-PROGRESS-GAP")),
              "nogap" !== r.gaptype &&
          ...
          (i[a].progressCBarInner =
            i[a].progressC[0].getElementsByTagName("RS-PROGRESS-BAR")),
      ...
      if (
        ...
        if ("horizontal" === r.style || "vertical" === r.style) {
          ...
          if ("horizontal" === r.style) {
            var c =
              "grid" === r.alignby ? i[a].gridwidth[i[a].level] : i[a].width;
            ...
            c =
              "grid" === r.alignby ? i[a].gridheight[i[a].level] : i[a].height;
            (n = Math.ceil(c / i[a].slideamount)),
              (l = Math.ceil((c - d * r.gapsize) / i[a].slideamount)),
              tpGS.gsap.set(i[a].progressC, {
                visibility: "visible",
        ...
        i[e].c.on("starttimer", function () {
          i[e].progressC != t &&
            (i[e].forcepaused ||
              (1 != i[e].conthover &&
                1 != i[e].stopByVideo &&
                i[e].width > i[e].hideSliderAtLimit &&
                1 != i[e].tonpause &&
                1 != i[e].overnav &&
                1 != i[e].ssop &&
                (1 === i[e].noloopanymore ||
      ...
      return (function (i) {
        ...
        i.navigation.maintypes))
          i.navigation.maintypes.hasOwnProperty(a) &&
            ...
            ((i.navigation[i.navigation.maintypes[a]].animDelay =
              i.navigation[i.navigation.maintypes[a]].animDelay === t
                ? 1e3
                : i.navigation[i.navigation.maintypes[a]].animDelay),
            (i.navigation[i.navigation.maintypes[a]].animSpeed =
              i.navigation[i.navigation.maintypes[a]].animSpeed === t
                ? 1e3
                : i.navigation[i.navigation.maintypes[a]].animSpeed),
            (i.navigation[i.navigation.maintypes[a]].animDelay =
        ...
        return (
          ...
          "IE" !== window.RSBrowser &&
            ...
            (!i.customEases.BounceSolid &&
              "true" != i.customEases.BounceSolid) ||
              tpGS.BounceSolid !== t ||
  ...
  (function ($, undefined) {
    ...
    jQuery.extend(!0, _R, {
      ...
      scrollToId: function (e) {
        ...
        (a +=
          "scrollbelow" === e.action ? jQuery(_R[e.id].slides[0]).height() : 0),
    ...
    jQuery.extend(!0, t, {
      prepareCarousel: function (e, i, a) {
        if (void 0 !== e) {
          ...
          (o.slidepositions =
            ...
            (o.slide_offset =
              void 0 !== o.slide_offset && jQuery.isNumeric(o.slide_offset)
                ? o.slide_offset
                : 0),
            (o.swipeTo = o.slide_offset + s(e)),
            (o.swipeToDistance = Math.abs(o.slide_offset) + Math.abs(s(e))),
            void 0 !== o.swipeTo && jQuery.isNumeric(o.swipeTo)
              ? void 0 !== a
                ? t.swipeAnimate({
                    id: e,
                    to: o.swipeTo,
      ...
      loadVisibleCarouselItems: function (e, i) {
        ...
        (t[e].carousel.focused = parseInt(t[e].carousel.focused, 0)),
          (t[e].carousel.focused = jQuery.isNumeric(t[e].carousel.focused)
                ...
                (s.wrapwidth >= s.maxwidth &&
                  ...
                  s.slidepositions[y] + s.slide_widths[y] > s.windhalf
                    ...
                    : "left" === s.horizontal_align &&
                      ...
                      s.slidepositions[y] < s.windhalf &&
                      (!w || s.slidepositions[y] < x)
                    ? ((s.focused = y), (w = !0), (x = s.slidepositions[y]))
                    : "right" === s.horizontal_align &&
      ...
      setCarouselDefaults: function (e, i) {
        ...
        if (
          ...
          void 0 === t[e].navOutterOffsets &&
            (t[e].navOutterOffsets = t.getHorizontalOffset(t[e].c, "all")),
          !0 !== i &&
            ((a = t[e].navOutterOffsets.left),
          ...
          (o.wrapwidth =
            "auto" != t[e].sliderLayout
              ? o.wrapwidth > t[e].conw
                ? t[e].conw
                : o.wrapwidth
              : o.wrapwidth > t[e].width
              ? t[e].width
              : o.wrapwidth),
          !0 === o.justify)
        ) {
          ...
          for (var s = 0; s < o.len; s++)
            if (t[e].slides.hasOwnProperty(s)) {
              ...
              (n = void 0 === n || 0 === n || null === n ? o.ratio : n),
                ...
                !1 !== o.justifyMaxWidth &&
                  (o.slide_widths[s] = Math.min(
                    o.wrapwidth,
                    o.slide_widths[s]
                  )),
                o.slide_widths[s] !== o.slide_widthsCache[s] &&
                  ((o.slide_widthsCache[s] = o.slide_widths[s]),
                  !0 !== i &&
                    tpGS.gsap.set(t[e].slides[s], {
        ...
        if (
          ...
          (void 0 !== o.cacheWrapObj &&
            d.left === o.cacheWrapObj.left &&
            d.right === o.cacheWrapObj.right &&
            d.width === o.cacheWrapObj.width) ||
            (window.requestAnimationFrame(function () {
            ...
            (o.inneroffset =
              "right" === o.horizontal_align ? o.wrapwidth - o.slide_width : 0),
            (o.windhalf =
              "auto" === t[e].sliderLayout ? t[e].width / 2 : t.winW / 2);
        }
      },
    });
    var i = function (e, i) {
  ...
  (function (e) {
    ...
    jQuery.extend(!0, o, {
      ...
      requestLayerUpdates: function (e, t, i, a) {
        ...
        if ("enterstage" === t) {
          ...
          if (
            ...
            void 0 !== o[e].middleZones[s]
          )
            for (r = 0; r < o[e].middleZones[s].length; r++)
              tpGS.gsap.set(o[e].middleZones[s][r], {
                y:
                  Math.round(
                    o[e].height / 2 - o[e].middleZones[s][r].offsetHeight / 2
                  ) + "px",
              });
          if (o[e].smiddleZones && o[e].smiddleZones.length > 0)
            for (r = 0; r < o[e].smiddleZones.length; r++)
              tpGS.gsap.set(o[e].smiddleZones[r], {
                y:
                  Math.round(
                    o[e].height / 2 - o[e].smiddleZones[r].offsetHeight / 2
                  ) + "px",
              });
          void 0 !== i &&
          ...
          if (o[r].layers[e.skey].hasOwnProperty(n)) {
            ...
            var g =
                "carousel" === o[r].sliderType
                  ? 0
                  : o[r].width / 2 - (o.iWA(r, e.slideIndex) * o[r].bw) / 2,
              u = 0;
            if (void 0 === c) {
              if (
                (o.revCheckIDS(r, l),
              ...
              if (
                ...
                (p.group =
                  "group" !== p.type && d.closest("rs-group-wrap").length > 0
                    ? "group"
                    : "column" !== p.type && d.closest("rs-column").length > 0
                    ? "column"
                    : "row" !== p.type && d.closest("rs-row").length > 0
                    ? "row"
                    : void 0),
                (p._lig =
                  "group" === p.group
              ...
              if (
                (void 0 !== p.spike && (p.spike = C(p.spike)),
                void 0 !== p.corners)
              )
            ...
            var m =
              ...
              y = o[r].useFullScreenHeight
                ? o[r].height
                : "grid" === p.basealign
                ? o[r].height
                : ("carousel" !== o[r].sliderType || p._isstatic, o[r].height),
              b = p.x[o[r].level],
              _ = p.y[o[r].level];
            if (
              ((u =
                "slide" === p.basealign
                  ...
                  : Math.max(
                      ...
                      "fullscreen" == o[r].sliderLayout
                        ? y / 2 -
                            (o.iHE(r) * (o[r].keepBPHeight ? 1 : o[r].bh)) / 2
                        : o[r].autoHeight ||
                          (null != o[r].minHeight && o[r].minHeight > 0)
                        ? o[r].conh / 2 - (o.iHE(r) * o[r].bh) / 2
                        : u
                    )),
              ...
              "slide" !== p.basealign &&
                ...
                (g = Math.max(
                  ...
                  "center" === o[r].carousel.horizontal_align
                    ? 0 + (o[r].width - o.iWA(r, "static") * o[r].bw) / 2
                    : "right" === o[r].carousel.horizontal_align
                    ? o[r].width - o[r].gridwidth[o[r].level] * o[r].bw
                    : g
                )),
              ...
              if (
                ...
                (m < o[r].hideLayerAtLimit && "on" == p.layeronlimit) ||
                m < o[r].hideAllLayerAtLimit
                  ? (!0 !== p.layerIsHidden &&
                ...
                if (
                  ((L =
                    "auto" === L
                      ? L
                      : !jQuery.isNumeric(L) && L.indexOf("%") > 0
                      ? p._incolumn || p._ingroup
                        ? "100%"
                        : "grid" === p.basealign
                        ? o.iWA(r, e.slideIndex) * o[r].bw
                        : m
                      : "off" !== p.rsp_bd
                      ? parseFloat(L) * o[r].bw + "px"
                      : parseFloat(L) + "px"),
                  (T =
                    "auto" === T
                      ? T
                  ...
                  -1 != d[0].className.indexOf("rs-fsv") || S
                    ? ((g = 0),
                      (u = 0),
            ...
            if ("preset" !== e.mode) {
              ...
              0 == p.eow &&
                0 == p.eoh &&
                ((p.eow = o[r].width), (p.eoh = o[r].height)),
                (p.basealign = o[r].justifyCarousel ? "grid" : p.basealign);
              var P =
                  "on" === p.rsp_o
                    ? parseInt(p.voffset[o[r].level], 0) * o[r].bw
                    : parseInt(p.voffset[o[r].level], 0),
                B =
                  "on" === p.rsp_o
                    ? parseInt(p.hoffset[o[r].level], 0) * o[r].bw
                    : parseInt(p.hoffset[o[r].level], 0),
                G =
                  "grid" === p.basealign ? o.iWA(r, e.slideIndex) * o[r].bw : m,
                M =
                  "grid" === p.basealign
                    ? o.iHE(r) *
                      (o[r].keepBPHeight ||
              ...
              (1 == o[r].gridEQModule ||
                (void 0 !== p._lig &&
                  ...
                  "column" !== p.type &&
                  "group" !== p.type)) &&
                ((G = void 0 !== p._lig ? p._lig.width() : o[r].width),
                ...
                p._ingroup &&
                  (void 0 !== p._groupw &&
                    !jQuery.isNumeric(p._groupw) &&
                    p._groupw.indexOf("%") > 0 &&
                    (p.OBJUPD.lppmOBJ.minWidth = p._groupw),
                  void 0 !== p._grouph &&
                    !jQuery.isNumeric(p._grouph) &&
                    p._grouph.indexOf("%") > 0 &&
            ...
            ? (o[t].layers.individual =
                void 0 === o[t].layers.individual
                  ? "all" === o[t].carousel.showLayersAllTime
                    ? L(jQuery(o[t].c), "rs-layer", "rs-layer-static")
                    : L(jQuery(o[t].c), "rs-on-car")
                  : o[t].layers.individual)
            : ((o[t].layers[i] =
                void 0 === o[t].layers[i]
                  ? "all" === o[t].carousel.showLayersAllTime
              ...
              (o[t].sbas[i] =
                void 0 === o[t].sbas[i]
                  ? L(jQuery(o[t].slides[e.slide]), "rs-sba")
                  : o[t].sbas[i])),
      ...
      updateRowZones: function (e) {
        ((void 0 !== o[e.id].rowzones &&
          ...
          (o.setSize(e.id, void 0, "updateRowZones"),
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              if (
                "continue" === e.mode &&
                "frame_999" === e.frame &&
                (L || void 0 === h.lastRequestedMainFrame)
              )
                return;
              ...
              if ("frame_0" !== O && "frame_hover" !== O && "loop" !== O) {
                ...
                if (
                  ...
                  O !== e.frame &&
                    v &&
                    (f =
                      !0 === f && h.frames[O].timeline.waitoncall
                        ? "skiprest"
                        : !0 !== f && f),
                ...
                if (
                  ...
                  var R = h.frames[O],
                    ...
                    P = h.c,
                    B =
                      void 0 !== R.sfx && b(R.sfx.effect, h.m, R.timeline.ease),
                  ...
                  if (
                    ((D.force3D = !0),
                    "block" === B.type &&
                      ((B.ft[0].background = R.sfx.fxc),
                      (B.ft[0].visibility = "visible"),
                      (B.ft[1].visibility = "visible"),
                      z.add(
                        tpGS.gsap.fromTo(B.bmask_in, G / 2, B.ft[0], B.ft[1], 0)
                      ),
                      z.add(
                        tpGS.gsap.fromTo(B.bmask_in, G / 2, B.ft[1], B.t, G / 2)
                      ),
                    ...
                    void 0 !== R.bgcolor
                      ? R.bgcolor.indexOf("gradient") >= 0
                        ? (D.background = R.bgcolor)
                        : (D.backgroundColor = R.bgcolor)
                      : !0 === h.bgcolinuse &&
                        (h.bgcol.indexOf("gradient") >= 0
                          ? (D.background = h.bgcol)
                          : (D.backgroundColor = h.bgcol)),
                    void 0 !== I &&
                      (void 0 !== I.bgcolor
                      ...
                      if (void 0 !== R[t[F]] && !h.quickRendering) {
                        var E = h.splitText[t[F]],
                          ...
                          V = h.fff
                            ...
                            : void 0,
                          Y = h.frames[O].dosplit
                            ? void 0 === R[t[F]].delay
                              ? 0.05
                              : R[t[F]].delay / 100
                            : 0;
                        (h.color[s] === D.color && "frame_1" === O) ||
                          (Q.color = D.color),
                          void 0 !== H &&
                            h.color[s] !== H.color &&
                            (V.color = H.color),
                        ...
                        delete X.dir,
                          ...
                          (X.stagger =
                            "center" === q || "edge" === q
                              ? d({ each: Y, offset: Y / 2, from: q })
                              : { each: Y, from: q }),
                          (X.duration = G),
                          void 0 !== J && delete J.dir,
                          h.fff
                            ? z.add(C.fromTo(E, J, X), 0)
                            : z.add(C.to(E, X), 0),
                    ...
                    h.fff
                      ? ((D.visibility = "visible"),
                        ...
                        o[r].BUG_safari_clipPath &&
                          (H.clipPath || D.clipPath || h.spike) &&
                          ((H.z && parseInt(H.z, 10)) || (H.z = -1e-4),
                          (D.z && parseInt(D.z, 10)) || (D.z = 0)),
                        void 0 !== h.cbg && "column" === h.type
                          ? z.fromTo(P, G, n(H), n(D), 0)
                          : z.fromTo(P, G, H, D, 0),
                        z.invalidate())
                      : (void 0 !== h.cbg && z.to(h.cbg, G, D, 0),
                        !o[r].BUG_safari_clipPath ||
                          (!D.clipPath && !h.spike) ||
                          (D.z && parseInt(D.z, 10)) ||
                          (D.z = 0 - 0.01 * Math.random()),
                        void 0 !== h.cbg && "column" === h.type
                          ? z.to(P, G, n(D), 0)
                          : z.to(P, G, D, 0)),
                    void 0 !== N &&
                  ...
                  var U =
                    ("trigger" !== e.mode &&
                      ((!0 !== f && "skiprest" !== f) ||
                        "rebuild" !== e.mode)) ||
                    e.frame === O ||
                    void 0 === R.timeline.start ||
                    !jQuery.isNumeric(R.timeline.start)
                      ? "+=0" === R.timeline.start ||
                        void 0 === R.timeline.start
                        ? "+=0.05"
                        : parseInt(R.timeline.start, 0) / 1e3
                      : "+=" + parseInt(R.timeline.startRelative, 0) / 1e3;
          ...
          if (void 0 !== h.frames.loop) {
            ...
            var ie = h.frames.loop.frame_0,
              ...
              re =
                "blur(" +
                parseInt(ie.blur || 0, 0) +
                "px) grayscale(" +
                parseInt(ie.grayscale || 0, 0) +
                "%) brightness(" +
                parseInt(ie.brightness || 100, 0) +
                "%)",
              oe =
                "blur(" +
                (ae.blur || 0) +
            ...
            if (
              ...
              void 0 === i &&
                (i =
                  "isometric" === o[r].perspectiveType
                    ? 0
                    : "local" === o[r].perspectiveType && void 0 !== D
                    ? void 0 !== D.transformPerspective
                      ? D.transformPerspective
                      : h.fff && void 0 !== H.transfromPerspective
                      ? H.transfromPerspective
              ...
              var se = parseInt(h.frames.loop.timeline.radiusAngle, 0) || 0,
                ne = [
                  ...
                  { x: 0, y: (ie.y + ie.yr) * o[r].bw, z: 0 },
                  {
                    x: (ae.x + ae.xr) * o[r].bw,
                    y: 0,
                    z: (ae.z + ae.zr) * o[r].bw,
                  },
                  { x: 0, y: (ae.y - ae.yr) * o[r].bw, z: 0 },
                ],
                le = {
                  type: "thru",
              ...
              for (var de in ne)
                ne.hasOwnProperty(de) &&
                  ((le.path[de] = ne[se]), (se = ++se == ne.length ? 0 : se));
              (("trigger" !== e.mode && "frame_999" !== e.frame) ||
                "frame_999" !== e.frame) &&
                h.loop.preset.fromTo(
                  ...
                  ee,
                  {
                    ...
                    transformOrigin:
                      ae.originX + " " + ae.originY + " " + ae.originZ,
                    opacity: 1,
                  },
                  l({
                    x: le.path[3].x,
                ...
                h.loop.move.to(
                  h.lp,
                  h.frames.loop.timeline.yoyo_move ? K / 2 : K,
            ...
            h.loop.rotate.to(
              h.lp,
              h.frames.loop.timeline.yoyo_rotate ? K / 2 : K,
              {
              ...
              h.loop.scale.to(
                h.lp,
                h.frames.loop.timeline.yoyo_scale ? K / 2 : K,
                l({
                  scaleX: ae.scaleX,
                  scaleY: ae.scaleY,
                  skewX: ae.skewX,
            ...
            h.loop.filter.to(
              h.lp,
              h.frames.loop.timeline.yoyo_filter ? K / 2 : K,
              ce
            ),
                      ...
                      if (h.animationonscroll || h.readyForHover) {
                        if (
                          ...
                          (h.svgHTemp.fill = t),
                            ...
                            h.hovertimeline.to(h.svgPath, pe, { fill: t }, 0);
                        }
          ...
          if (
            ...
            if (
              ...
              if (void 0 === h.childrenJS)
                for (var F in ((h.childrenJS = {}), o[r]._L))
                  void 0 !== o[r]._L[F]._lig &&
                    void 0 !== o[r]._L[F]._lig[0] &&
                    o[r]._L[F]._lig[0].id === a[0].id &&
                    o[r]._L[F]._lig[0].id !== o[r]._L[F].c[0].id &&
                    (h.childrenJS[o[r]._L[F].c[0].id] = o[r]._L[F].c);
              ...
              var ge =
                void 0 === e.totime
                  ? void 0 !== h.frames[e.frame].timeline.startAbsolute
                    ...
                    ? jQuery.isNumeric(h.frames[e.frame].timeline.start)
    ...
    var n = function (e) {
      ...
      u = function (e, t) {
        ...
        return (
          ...
          a.backgroundImage &&
            ...
            180 !== m(t.css("backgroundImage")) &&
            180 === m(a.backgroundImage) &&
        ...
        for (var l in a)
          if (a.hasOwnProperty(l)) {
            if (
              ...
              a[l].indexOf("%") >= 0 &&
              jQuery.isNumeric((t = parseInt(a[l], 0)))
            )
              a[l] =
                "x" === l
                  ? _(
      ...
      k = function (e, t) {
              ...
              e[n + "_mask"] && (i[n].mask = x(e[n + "_mask"], t).transform),
                ...
                i[n].transform.auto &&
                  ...
                  void 0 !== i.frame_0.filter &&
                    (i[n].filter = jQuery.extend(!0, {}, i.frame_0.filter)),
                  void 0 !== i.frame_0.mask &&
                    (i[n].mask = jQuery.extend(!0, {}, i.frame_0.mask)),
                  void 0 !== i.frame_0.chars &&
                    (i[n].chars = jQuery.extend(!0, {}, i.frame_0.chars)),
                  void 0 !== i.frame_0.words &&
                    (i[n].words = jQuery.extend(!0, {}, i.frame_0.words)),
                  void 0 !== i.frame_0.lines &&
                    (i[n].lines = jQuery.extend(!0, {}, i.frame_0.lines))),
                e[n + "_sfx"] &&
                  (i[n].sfx = x(e[n + "_sfx"], t, !1, void 0, "sfx").transform),
                e[n + "_reverse"] &&
                  (i[n].reverse = x(
                    e[n + "_reverse"],
                    t,
        ...
        return (
          e.resetfilter &&
            ((i.frame_0.filter = jQuery.extend(!0, {}, i.frame_0.filter)),
            ...
            (i.frame_0.filter.grayscale =
              void 0 === i.frame_0.filter.grayscale
                ...
                : i.frame_0.filter.grayscale)),
          void 0 !== i.frame_0.filter &&
            ((i.frame_1.filter = jQuery.extend(!0, {}, i.frame_1.filter)),
      ...
      S = function (e, t) {
        ...
        for (var l in e)
          "loop" !== l &&
            "frame_hover" !== l &&
            (a = jQuery.extend(!0, a, e[l]));
        for (var l in e)
          if (
            e.hasOwnProperty(l) &&
            (void 0 !== e[l].timeline && (e[l].timeline.usePerspective = !1),
            "loop" !== l && "frame_hover" !== l)
          ) {
            for (i in a.transform)
              a.transform.hasOwnProperty(i) &&
                ((a.transform[i] =
                  void 0 === e[l].transform[i]
                    ? "frame_0" === l
                      ? window.rdF0.transform[i]
                      : "frame_1" === l
                      ? window.rdF1.transform[i]
                      : a.transform[i]
                    : e[l].transform[i]),
                (e[l].transform[i] =
                  void 0 === e[l].transform[i]
            ...
            for (var d = 1; d <= 4; d++)
              for (i in a[r[d]])
                a[r[d]].hasOwnProperty(i) &&
                  ((e[l][r[d]] = void 0 === e[l][r[d]] ? {} : e[l][r[d]]),
                  (a[r[d]][i] =
                    void 0 === e[l][r[d]][i]
                      ? "frame_0" === l
                        ? window.rdF0[r[d]][i]
                      ...
                      : e[l][r[d]][i]),
                  (e[l][r[d]][i] =
                    void 0 === e[l][r[d]][i] ? a[r[d]][i] : e[l][r[d]][i]));
            void 0 === e[l].timeline ||
              !1 !== e[l].timeline.usePerspective ||
              void 0 === e[l].transform ||
              (void 0 === e[l].transform.rotationY &&
                void 0 === e[l].transform.rotationX &&
                void 0 === e[l].transform.z) ||
              ((s =
                "local" == o[t].perspectiveType
                  ? void 0 === e[l].transform.transformPerspective
                    ? 600
                    : e[l].transform.transformPerspective
                  : s),
      ...
      O = function (e, t, s) {
        ...
        var l = window.getComputedStyle(e[0], null),
          ...
          p =
            void 0 !== c &&
            l.fontSize == c.css("fontSize") &&
            T(l.fontWeight) == T(c.css("fontWeight")) &&
            l.lineHeight == c.css("lineHeight"),
          g = p
            ? void 0 !== c[0].id && void 0 !== o[s]._L[c[0].id]
              ? o[s]._L[c[0].id]
              : c.data()
            : void 0,
          u = 0;
        for (
          d.basealign = void 0 === d.basealign ? "grid" : d.basealign,
            d._isnotext ||
              ...
              (d.letterSpacing = o.revToResp(
                p
                  ? void 0 === g.letterspacing
                    ? parseInt(c.css("letterSpacing"), 0) || "inherit"
                    : g.letterspacing
                  : void 0 === d.letterspacing
                  ? parseInt(
                      "normal" === l.letterSpacing ? 0 : l.letterSpacing,
                      0
                    ) || "inherit"
                  : d.letterspacing,
                o[s].rle
            ...
            d.zIndex = p
              ? void 0 === g.zindex
                ? parseInt(c.css("zIndex"), 0) || "inherit"
                : g.zindex
              : void 0 === d.zindex
              ? parseInt(l.zIndex, 0) || "inherit"
              : d.zindex,
            n = 0;
          n < 4;
          n++
          ...
          (d["padding" + i[n]] = o.revToResp(
            void 0 === d["padding" + r[n]]
              ? parseInt(l["padding" + i[n]], 0) || 0
              : d["padding" + r[n]],
            o[s].rle
          )),
            (d["margin" + i[n]] = o.revToResp(
              void 0 === d["margin" + r[n]]
                ? parseInt(l["margin" + i[n]], 0) || 0
                : d["margin" + r[n]],
              o[s].rle
            )),
            (d["border" + i[n] + "Width"] =
              void 0 === d.borderwidth
                ? parseInt(l["border" + i[n] + "Width"], 0) || 0
                : d.borderwidth[n]),
            (d["border" + i[n] + "Color"] =
            ...
            (d["border" + a[n] + "Radius"] = o.revToResp(
              void 0 === d.borderradius
                ? l["border" + a[n] + "Radius"] || 0
                : d.borderradius[n],
              o[s].rle
            ));
        for (
          d.borderStyle = o.revToResp(
            void 0 === d.borderstyle ? l.borderStyle || 0 : d.borderstyle,
            o[s].rle
          ),
            "rekursive" !== t
              ? ((d.color = o.revToResp(
                ...
                (d.minWidth = o.revToResp(
                  void 0 === d.minwidth
                    ? parseInt(l.minWidth, 0) || 0
                    : d.minwidth,
                  o[s].rle
                )),
                (d.minHeight = o.revToResp(
                  void 0 === d.minheight
                    ? parseInt(l.minHeight, 0) || 0
                    : d.minheight,
                  o[s].rle
                )),
                (d.width = o.revToResp(
          ...
          if (void 0 !== e) {
            ...
            return (
              l._isnotext ||
                ...
                void 0 !== l.tstroke &&
                  (d.textStroke =
                    parseInt(l.tstroke.w, 0) + "px " + l.tstroke.c)),
              void 0 !== l.bshadow &&
                (d.boxShadow =
        ...
        if (-1 === k.indexOf("rs_splitted_")) {
            ...
            "column" === x.type &&
              (void 0 === x.cbg_set &&
                ...
                "" !== x.cbg_img &&
                  void 0 !== x.cbg_img &&
                  "none" !== x.cbg_img &&
                  ((x.cbg_img_r = m.css("backgroundRepeat")),
          ...
          if (
            ("IFRAME" == m[0].nodeName &&
              ...
              (s.width =
                !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0
                  ? !x._isstatic || x._incolumn || x._ingroup
                    ? e.width
                    : (u * parseInt(e.width, 0)) / 100
                  : R(e.width, L, "auto", u, "auto")),
              (s.height =
                !jQuery.isNumeric(e.height) && e.height.indexOf("%") >= 0
                  ? !x._isstatic || x._incolumn || x._ingroup
                    ? e.height
                    : (h * parseInt(e.height, 0)) / 100
                  : R(e.height, L, "auto", u, "auto"))),
              ...
              (O.width = "100%"),
                ...
                (C.width =
                  !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0
                    ? "100%"
                    : A),
                "image" === x.type && tpGS.gsap.set(x.img, { width: C.width });
            } else
              !jQuery.isNumeric(e.width) &&
                e.width.indexOf("%") >= 0 &&
                ((T.minWidth =
                  "slide" === x.basealign || !0 === x._ingroup
                    ? A
                    : (o.iWA(f, b) * o[f].bw * parseInt(A)) / 100 + "px"),
                (O.width = "100%"),
                (w.width = "100%"));
            if (
              (!jQuery.isNumeric(e.height) &&
                e.height.indexOf("%") >= 0 &&
                ((T.minHeight =
                  "slide" === x.basealign || !0 === x._ingroup
                    ? z
              ...
              x._ingroup &&
                ((x._groupw = C.minWidth), (x._grouph = C.minHeight)),
              "row" === x.type &&
              (jQuery.isNumeric(C.minHeight) ||
                C.minHeight.indexOf("px") >= 0) &&
              "0px" !== C.minHeight &&
              0 !== C.minHeight &&
              "0" !== C.minHeight &&
              "none" !== C.minHeight
                ? (C.height = C.minHeight)
                : "row" === x.type && (C.height = "auto"),
              x._isstatic &&
                x.elementHovered &&
                (p = m.data("frames")) &&
                p.frame_hover &&
            ...
            "group" !== x.type &&
              "row" !== x.type &&
              "column" !== x.type &&
              (!jQuery.isNumeric(C.width) &&
                C.width.indexOf("%") >= 0 &&
                (C.width = "100%"),
              !jQuery.isNumeric(C.height) &&
                C.height.indexOf("%") >= 0 &&
                (C.height = "100%")),
              x._isgroup &&
                (!jQuery.isNumeric(C.width) &&
          ...
          "auto" === T.maxWidth && (T.maxWidth = "inherit"),
            ...
            void 0 === x.imgOBJ ||
              ...
              ((x.caches.imgOBJ = jQuery.extend(!0, {}, x.imgOBJ)),
            ...
            void 0 === x.mediaOBJ ||
              ...
              ((x.caches.mediaOBJ = jQuery.extend(!0, {}, x.mediaOBJ)),
              x.media.css(x.mediaOBJ)),
            n != o[f].emptyObject &&
              n != x.caches.LOBJ &&
              (tpGS.gsap.set(m, _), (x.caches.LOBJ = n)),
            l != o[f].emptyObject &&
              l != x.caches.LPOBJ &&
              (tpGS.gsap.set(x.lp, O), (x.caches.LPOBJ = l)),
            d != o[f].emptyObject &&
              d != x.caches.MOBJ &&
              (tpGS.gsap.set(x.m, w), (x.caches.MOBJ = d)),
            c != o[f].emptyObject &&
              c != x.caches.POBJ &&
              (tpGS.gsap.set(x.p, T),
              (x.caches.POBJ = c),
      ...
      C = function (e) {
        ...
        return (
          "polygon(" +
          P(t.l, 0, parseFloat(t.lw)) +
          "," +
          P(t.r, 100, 100 - parseFloat(t.rw), !0) +
          ")"
        );
      },
      P = function (e, t, i, a) {
  ...
  (function (e) {
    ...
    jQuery.extend(!0, t, {
        ...
        if (
          ...
          if (
            ...
            p(s) &&
              ...
              o(e, a, r, t[e].c, s, t[e].slideamount, "tab"),
            p(n) &&
              (i || n.width > n.min_width) &&
              o(e, a, r, t[e].c, n, t[e].slideamount, "thumb", e),
            p(l) && i)
          ) {
      ...
      showFirstTime: function (e) {
        u(e),
          jQuery.isEmptyObject(t[e].caches.contWidthManager) &&
            t.callContWidthManager(e),
          t.hideUnHideNav(e);
      },
            ...
            y &&
              ...
              k &&
                (t[e].navigation.tabs.rtl
                  ? x(t[e].c, h, L, "tp-tab", e)
                  : x(t[e].c, h, T, "tp-tab", e));
          }
        y && _(o, e),
          b && _(l, e),
          k && _(h, e),
    ...
    var r = function (e, i) {
      ...
      o = function (e, i, a, r, o, s, n) {
        ...
        a.add(tpGS.gsap.set(l, m)),
          a.add(tpGS.gsap.set(d, { width: u + "px", height: h + "px" })),
          a.add(tpGS.gsap.set(c, { width: u + "px", height: h + "px" })),
            ...
            jQuery.each(f, function (e, t) {
              "vertical" === o.direction
                ? a.add(
                    tpGS.gsap.set(t, {
                      top:
                        e * (g + parseInt(void 0 === o.space ? 0 : o.space, 0)),
                      width: p + "px",
                      height: g + "px",
                    })
                  )
                : "horizontal" === o.direction &&
                  a.add(
                    tpGS.gsap.set(t, {
                      left:
                        e * (p + parseInt(void 0 === o.space ? 0 : o.space, 0)),
                      width: p + "px",
                      height: g + "px",
                    })
                  );
          ...
          jQuery(".rs-nav-element").rsswipe({
            ...
            swipeStatus: function (i, o, s, n, d, c, p) {
              ...
              var f =
                ...
                A =
                  "vertical" === L
                    ? k.find(w).first().outerHeight(!0) + x.space
                    : k.find(w).first().outerWidth(!0) + x.space,
                R =
                ...
                case "move":
                  ...
                  (I =
                    I < z
                      ? "horizontal" === L
                        ? I +
                          (((S.width() * (I - z)) / S.width()) * (I - z)) /
                            S.width()
                        : I +
                          (((S.height() * (I - z)) / S.height()) * (I - z)) /
                            S.height()
                      : I),
                    "vertical" === L
            ...
            t[e].c.rsswipe({
              ...
              fingers:
                t[e].navigation.touch.swipe_min_touches > 5
                  ...
                  : t[e].navigation.touch.swipe_min_touches,
              excludedElements:
                "label, button, input, select, textarea, .noSwipe, .rs-nav-element, .rs-waction",
        ...
        if (null != e && void 0 !== e.c) {
          ...
          if (
            ...
            "outer-right" !== e.position
              ...
              : ((d.maxWidth = e.maxw), (c.maxWidth = r + "px")),
                ...
                ? ("layergrid" == e.container &&
                  ...
                  "vertical" === e.direction
                    ...
                    : "horizontal" === e.direction &&
                      ...
                      (d.x = 0),
                      (c.maxWidth =
                        e.maxw >= r ? "100%" : Math.min(e.maxw, r) + "px"),
                      tpGS.gsap.set(e.c, d),
                      tpGS.gsap.set(e.mask, c),
                      b(e.mask, e, i)))
                : (tpGS.gsap.set(e.c, d), tpGS.gsap.set(e.mask, c));
          }
        }
      },
      w = function (e, i, a, r) {
      ...
      x = function (e, i, a, r, o) {
        ...
        "vertical" === i.direction
          ? (f.css({ top: (v - 1) * w + "px", left: "0px" }),
            h.css({ height: (v - 1) * w + b, width: y }))
          : (f.css({ left: (v - 1) * _ + "px", top: "0px" }),
            h.css({ width: (v - 1) * _ + y, height: b })),
      ...
      k = function (e) {
        ...
        (t[e].top_outer = i.hasClass("tp-forcenotvisible")
          ...
          (t[e].bottom_outer = a.hasClass("tp-forcenotvisible")
            ? 0
            : a.outerHeight() || 0),
          ((void 0 !== r && r !== t[e].top_outer) ||
            (void 0 !== o && o !== t[e].bottom_outer)) &&
            t.setSize(e, void 0, "setONHeights");
      },
      S = function (e, i, a) {
        return null == e || void 0 === e.c
          ? a
          : (e.hide_under > t[i].conw || t[i].conw > e.hide_over
              ? (!0 !== e.tpForceNotVisible &&
                  (e.c.addClass("tp-forcenotvisible"), (a = !0)),
                (e.tpForceNotVisible = !0))
              : (!1 !== e.tpForceNotVisible &&
                  (e.c.removeClass("tp-forcenotvisible"), (a = !0)),
            ...
            (void 0 === t[i].carousel.slide_width &&
              (t[i].carousel.slide_width =
                !0 !== t[i].carousel.stretch
                  ? t[i].gridwidth[t[i].level] * (0 === t[i].bw ? 1 : t[i].bw)
                  : t[i].conw),
            void 0 === t[i].carousel.slide_height &&
              (t[i].carousel.slide_height =
                !0 !== t[i].carousel.stretch
                  ? t[i].gridheight[t[i].level] * (0 === t[i].bw ? 1 : t[i].bw)
                  : t[i].conh)),
          !0 !== t[i].CWMDONE && (t.contWidthManager(i), t.setSize(i)));
        var s = e.data(),
          n = e.find("rs-sbg"),
          ...
          if (
            ...
            (s.panvalues.duration =
              NaN === s.panvalues.duration || void 0 === s.panvalues.duration
                ? 10
                : s.panvalues.duration),
            tpGS.gsap.set(u, { width: m.start.width, height: m.start.height }),
            delete m.start.width,
            delete m.start.height,
            "prepare" === o &&
              tpGS.gsap.fromTo(u, 0.5, { autoAlpha: 0 }, { autoAlpha: 1 }),
            t[i].panzoomTLs[r].add(
              tpGS.gsap.fromTo(u, s.panvalues.duration, m.start, m.end),
              0
            ),
            t[i].panzoomTLs[r].add(
              tpGS.gsap.fromTo(h, s.panvalues.duration, m.starto, m.endo),
              0
            ),
        ...
        ("3D" != i.type && "3d" != i.type) ||
          i.sctors.each(function () {
            var s = jQuery(this),
              ...
              d = r * n,
              p =
                0 == t[e].conw ? 0 : Math.round((a / t[e].conw) * n * 100) || 0,
              g =
                0 == t[e].conh ? 0 : Math.round((r / t[e].conh) * n * 100) || 0,
            ...
            "deviceorientation" === o.type &&
              ...
              (p =
                0 == t[e].conw
                  ? 0
                  : Math.round((a / t[e].conw) * n * 500) || 0),
              (g =
                0 == t[e].conh
                  ? 0
                  : Math.round((r / t[e].conh) * n * 700) || 0)),
              s.hasClass("dddwrapper-layer") &&
                ((h = i.ddd_z_correction || 65), (m = !0)),
      ...
      parallaxProcesses: function (e, a, r, o) {
        var s = t[e].fixedOnTop
            ...
            : Math.min(
                ...
                Math.max(
                  0,
                  1 - (a.top + a.hheight) / (a.hheight + t.lastwindowheight)
                )
              ),
          n =
              ...
              a.top >= 0 && a.top <= t.lastwindowheight
                ...
                ? (!0 !== t.stickySupported &&
                  ...
                  (s =
                    (t[e].sbtimeline.fixStart +
                      t[e].sbtimeline.time *
                        (Math.abs(a.top) / (a.hheight - t[e].height))) /
                    1e3))
                : (!0 !== t.stickySupported &&
                  ...
                  (s =
                    a.top > t.lastwindowheight
                      ...
                      : (t[e].sbtimeline.fixEnd +
                          t[e].sbtimeline.rest * (1 - a.bottom / t[e].height)) /
                        1e3)))
            ...
            for (var p = 0; p < c.pcontainers.length; p++)
              if (c.pcontainers[p].length > 0) {
                var g = c.pcontainers[p],
                  ...
                  h =
                    Math.round(t[e].scrollproc * (-u * t[e].conh) * 10) / 10 ||
                    0,
          ...
          if (c.bgcontainers)
            for (p = 0; p < c.bgcontainers.length; p++) {
              ...
              (h = t[e].scrollproc * (-v * t[e].conh) || 0),
                (m = void 0 !== o ? o : c.speedbg / 1e3 || 0.015);
              (m =
                void 0 !== t[e].parallax.lastBGY &&
                0 === m &&
                Math.abs(h - t[e].parallax.lastBGY) > 50
                  ? 0.15
                  : m),
                tpGS.gsap.to(f, m, {
                  position: "absolute",
        ...
        if (y.set && (!i || !1 === y.disable_onmobile)) {
          ...
          if (((b = b < 0 ? 0 : b), !1 !== y._L)) {
            var _ = 1 - b * y.multiplicator_layers,
              w = { force3D: "true" };
            if (
              ("top" == y.direction && t[e].scrollproc >= 0 && (_ = 1),
          ...
          if (!1 !== y.bgs) {
            (_ = 1 - b * y.multiplicator),
              (w = { backfaceVisibility: "hidden", force3D: "true" });
    ...
    var a = function (e, i) {
      ...
      e.find(".dddwrapper-layertobggroup").appendTo(r),
        "carousel" == t[i].sliderType &&
          ...
          tpGS.gsap.set(r, { borderRadius: t[i].carousel.border_radius })),
        tpGS.gsap.set(e, {
          overflow: "visible",
          transformStyle: "preserve-3d",
          perspective: 1600,
      ...
      a = function (e) {
        ...
        if (
          ...
          (d < 11 ||
            ...
            18 === d ||
            (l.nTR >= 27 && l.nTR <= 30)) &&
            ((t[a].slots = i(e.animation.slotamount, u)),
            (t[a].slots =
          ...
          m.length > 0 &&
            ((c = !0),
            t[a].mtl.add(tpGS.gsap.set(m, { zIndex: 0, display: "none" }), 0),
            setTimeout(
              function () {
                void 0 !== t[a].videoIsPlaying &&
                  t[a].videoIsPlaying.length > 0 &&
                  t[a].videoIsPlaying[0].id == m[0].id &&
                  t.stopVideo(m, a);
              },
              h > 50 ? 50 : h - 20
            ),
        ...
        if (
          ((_ =
            "default" === _ || "d" === _
              ? l.TR[8] || "power2.inOut"
              : _ || l.TR[8] || "power2.inOut"),
          (w =
            "default" === w || "d" === w
              ? l.TR[9] || "power2.inOut"
              : w || l.TR[9] || "power2.inOut"),
          d >= 31)
        ) {
          var x = {
          ...
          if (
            ...
            void 0 !== x.col_next &&
              x.col_next.indexOf("gradient") >= 0 &&
              (x.col_next = "transparent"),
            void 0 !== x.col_act &&
              x.col_act.indexOf("gradient") >= 0 &&
              (x.col_act = "transparent"),
            31 === d)
          ) {
            for (
              var k =
                  "transparent" !== x.col_next && void 0 !== x.col_next
                    ? { x: 0, y: 0, width: t[a].width, height: t[a].height }
                    : r(
                        "contain" === x.oBG_next.style.backgroundSize,
                        t[a].width,
                        t[a].height,
                        x.img_next.width,
                        x.img_next.height
                ...
                S =
                  void 0 === x.oBG_act
                    ? void 0
                    : "transparent" !== x.col_act && void 0 !== x.col_act
                    ? { x: 0, y: 0, width: t[a].width, height: t[a].height }
                    : r(
                        "contain" === x.oBG_act.style.backgroundSize,
                        t[a].width,
                        t[a].height,
                        x.img_act.width,
                        x.img_act.height
                      ),
                L = t[a].width / t[a].slots,
                T = L / 2,
                O = t[a].height,
                A = [],
                R = 0;
        ...
        if (0 == d) {
          ...
          (h = Math.min(t[a].duration || h, h)),
            t[a].pr_active_bg.find(".slotslide").each(function (e) {
              ...
              t[a].mtl.add(
                tpGS.gsap.to(this.getElementsByTagName("div"), h / 1e3, {
          ...
          switch (((h = 0 === h ? 10 : h), l.trC)) {
            ...
            case 4:
              t[a].mtl.add(
                ...
                g &&
                  t[a].mtl.add(
                    tpGS.gsap.to(t[a].pr_active_bg, h / 2e3, {
                      autoAlpha: 0,
                      force3D: "auto",
                      ease: _,
                    }),
              ...
              p &&
                t[a].mtl.add(
                  tpGS.gsap.fromTo(
                    t[a].pr_next_bg,
                    h / 1e3,
                    { autoAlpha: 0, filter: D, "-webkit-filter": D },
                    {
                      autoAlpha: 1,
                      filter: H,
                      "-webkit-filter": H,
          ...
          var j = 3 == l.trC ? h / 1300 : h / 1e3,
            ...
            Y = 4 == l.trC || 5 == l.trC ? 0.6 : 6 == l.trC ? 1.4 : 1,
            X = 5 == l.trC ? 1.4 : 6 == l.trC ? 0.6 : 1;
          if (
            ((7 != l.trC && 4 != l.trC) || ((N = 0), (F = 0)),
            8 == l.trC
              ? (t[a].mtl.add(
            ...
            switch (d) {
              case 12:
                g &&
                  t[a].mtl.add(
                    tpGS.gsap.to(t[a].pr_active_bg, W, {
                      x: 0 - N + "px",
                      overflow: "hidden",
                      force3D: "auto",
                      scale: Y,
          ...
          (re[ge] = "0%"),
            ...
            g &&
              t[a].mtl.add(
                tpGS.gsap.fromTo(t[a].pr_active_bg, h / 1e3, re, oe),
                0
              ),
            p &&
              t[a].mtl.add(
            ...
            t[a].mtl.add(
              tpGS.gsap.fromTo(K.find(".slotslide div"), h / 1e3, ce, pe),
              0
            );
        }
        c &&
          ...
          switch (
            ...
            case "html5":
              ...
              "video" === s.tag &&
                ...
                e.find(s.tag).parent().hasClass("html5vid") ||
                  e
                    .find(s.tag)
                    .wrap(
                      '<div class="html5vid ' +
                        (!1 === s.afs ? "hidefullscreen" : "") +
                        '" style="position:relative;top:0px;left:0px;width:100%;height:100%; overflow:hidden;"></div>'
                    ),
